...
_C.LMDB = CN()
_C.LMDB.trainData_dir = "./dataset/lmdb/training"
_C.LMDB.imgH = 64
_C.LMDB.imgW = 256
...
_C.LMDB.testDir="./dataset/evaluation/SVT"
_C.LMDB.testShuffle=False
_C.LMDB.testBatchsize=1
_C.LMDB.testWorkers=0
# _C.LMDB.testResume="F:\pycharm_project\paddle_pren-main\PreModel\pre_paddle_model\pren"
_C.LMDB.testResume='./output/resume2/Epoch-8-Loss-0.18709387933158853'
...
_C.TRAIN.last_epoch = 8  #断点训练
_C.TRAIN.checkpoints = False
_C.TRAIN.resume ='./output/resume2/Epoch-8-Loss-0.18709387933158853'
_C.TRAIN.displayInterval = 10000

# test settings
_C.TEST = CN()
_C.TEST.display = False
_C.TEST.vert_test = True
_C.TEST.batchsize = 1
_C.TEST.workers = 1

# misc
_C.saveLogdir = "./output/log2"
_C.saveFreq = 1  # freq to save chpt
