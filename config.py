...
_C.LMDB = CN()
_C.LMDB.trainData_dir = "./dataset/aistudio/evaluation"
_C.LMDB.imgH = 64
_C.LMDB.imgW = 256
_C.LMDB.trainWorkers = 0
_C.LMDB.aug_prob = 0.3
_C.LMDB.random_seed = 1
_C.LMDB.trainShuffle = False
_C.LMDB.trainBatchsize = 40
...
_C.LMDB.testResume = './output/Epoch-8-Loss-0.18709387933158853'
